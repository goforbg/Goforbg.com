  ...
  return (
    <div key={lifeEvent.event.title} className="flex relative pt-10 items-center">
      ...
      <div className="flex-grow pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        <div className="relative flex-shrink-0 w-48 h-48 text-primary rounded-full inline-flex items-center justify-center overflow-hidden">
          <Image
...
const corona_2020_to_2021 = {
  ...
  learning: {
    title: 'What I learnt',
    desc: '<ul><li>To create wealth, your rewards should never be linked to your time or repetitiveness.</li><br/><li>A lot of times, Anger is just fear in disguise.</li></ul>',
  },
  event: {
    title: 'Wisdom Fuelled Pandemic',
    desc: 'I joined Workllama as an Android Engineer. I learned how to architect apps at scale. Conducted 30+ interviews, coded 5+ libraries. Learned how to build & ship applications using <b>Next js, React, Tailwind, Node js, Docker, and more!</b> <br/><br/> I discovered Naval Ravikanth, which led me to a gold pot of Entrepreneurship and Finance wisdom. I hunted several top-notch ProductHunt posts. ',
  },
}
...
const axilor_2019 = {
  ...
  learning: {
    title: 'What I learnt',
    desc: "<ul><li>The difference between a winner and a loser is defined by quitting not failing.</li><br/><li>Don't listen to people, just observe their actions.</li></ul>",
  },
  event: {
    title: 'The new kid on the block',
    desc: 'When I hear <b>"Bengaluru, Tech, & Startups"</b> my brain started lighting up. I had scored an Android internship with immense efforts at Bolkar (previously Pascolan) - a startup aiming to be the #1 Indian vernacular audio Q&A platform. <br/><br/>I could now suddenly write design libraries. Bolkar was a part of <b>Axilor Ventures</b> - One of India\'s finest Startup Accelerator that hosted 14 more top-tier teams that cohort, which made me interact with several second-time founders from IITs and IIMs.',
  },
}
...
const melbourne_2019 = {
  ...
  learning: {
    title: 'What I learnt',
    desc: '<ul><li>Losses are always perceived bigger than wins, use this information to your advantage.</li><br/><li>Change is possible only when you truly observe the constant state of change.</li></ul>',
  },
  event: {
    title: 'Hit the road Jack!',
    desc: 'I was interning at <b>Swinburne University, Melbourne</b>. It was my first time flying abroad, and it was amazing to write a paper on the Melbourne Water Plant. I got to interact with people from all over the world, which boosted my communication skills.<br/><br/> My paper was about water meters used in apartments that digitally track usage to deliver water bills and tap water recycled as consumables, which inspired me to learn Python.  It felt like I restarted life, and I was so grateful I could view life through a different lens. ',
  },
}
...
const college_disaster = {
  ...
  learning: {
    title: 'What I learnt',
    desc: "<ul><li>Travel enables new perspectives to broaden your mind.</li><br/><li>It's okay to be human and mess up once in a while, you'll bounce back.</li></ul>",
  },
  event: {
    title: 'College & Hackathons',
    desc: 'I strongly believe the best way to learn Programming is to <b>do and learn yourself.</b> I partied a lot! My lifeline during College was hackathons & workshops. I participated in hackathons across the country at CIT, Prodigy, IIT BHU, Smart India Hackathon, & more.<br/><br/> I learned a lot about Photography, improved my Public Speaking, Choreographic, Video-editing skills, and maintained 2 Youtube Channels - Androar & Foodmux. I Partnered up with a dozen of 3-star restaurants.',
  },
}
...
const boss_baby = {
  ...
  learning: {
    title: 'What I learnt',
    desc: "<ul><li>Money won't make you happy, but it gives you the choice to pick happiness.</li><br/><li>People will first try to stop you from doing something ambitious, it's human nature.</li></ul>",
  },
  event: {
    title: 'Best Student Entrepreneur',
    desc: "It all started when I jailbroke my mom's phone to run some games. It got me interested in smartphones, tech, and my blogging journey since the age of 12. I then started earning from Ad revenues, Writing, Migrating blog hosts, and running SEO Optimizations.<br/><br/> I got awarded as <b>the best student entrepreneur</b> for founding Twecco Solutions. The freelance firm had over 50 recurring clients. My ambition had become very clear.",
  },
}
